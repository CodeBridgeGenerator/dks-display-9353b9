...
const pTemplate1 = (rowData, { rowIndex }) => <p >{rowData.imgs}</p>
...
<Column field="imgs" header="Imgs" body={pTemplate1} filter={selectedFilterFields.includes("imgs")} hidden={selectedHideFields?.includes("imgs")}  sortable style={{ minWidth: "8rem" }} />
